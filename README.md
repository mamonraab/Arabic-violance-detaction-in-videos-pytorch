...
<br>
3- (Conv  +  lstm) :   هذه الطريقة تتيح لنا استخدام  transfer learning     لتحسين النتائج وهي الطريقة الاكثر شيوعا عندما يكون  لدينا عدد بيانات قليل وايضا قدرة الحاسوب من ناحية كارت الشاشة قليلة  ولذلك سنقوم بعمل الشرح على هذه الطريقة وايضا لن هذه الطريقة تحتج جهد خاص لتطويعها وفق بيئة  pytorch
